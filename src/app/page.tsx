...
function TimelineItem({
  ...
  const categoryConfig: Record<string, { color: string, icon: React.ReactNode }> = {
    climate: { color: "bg-blue-500/10 text-blue-400 border-blue-500/20", icon: <CloudRain className="w-3.5 h-3.5" /> },
    disaster: { color: "bg-red-500/10 text-red-400 border-red-500/20", icon: <ShieldAlert className="w-3.5 h-3.5" /> },
    news: { color: "bg-emerald-500/10 text-emerald-400 border-emerald-500/20", icon: <Newspaper className="w-3.5 h-3.5" /> },
    finance: { color: "bg-yellow-500/10 text-yellow-400 border-yellow-500/20", icon: <TrendingUp className="w-3.5 h-3.5" /> },
    astronomy: { color: "bg-purple-500/10 text-purple-400 border-purple-500/20", icon: <Moon className="w-3.5 h-3.5" /> },
  };
